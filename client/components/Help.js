  ...
  render() {
    return (
      <div className="ui grid stackable padded">
        ...
        <p>Currently eventeth is in a testing and development phase so it's not available in the mainnet yet.</p>
        ...
        <p><a
            href="https://github.com/mustfeez/eventeth/issues/new" target="_blank" rel="noopener noreferrer">
